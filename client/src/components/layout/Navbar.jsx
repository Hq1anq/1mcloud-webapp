...
export default function Navbar() {
  ...
  return (
    <nav className="bg-navbar border-b-border sticky top-0 z-50 flex items-center justify-between border-b-2 px-5 py-3 shadow-md select-none">
      ...
      {/* Menu Items */}
      <div
        className={`w-full overflow-hidden md:max-h-none md:w-auto md:overflow-visible ${isMenuOpen ? 'max-h-[500px]' : 'max-h-0'}`}
      >
        <ul className="bg-navbar-menu mt-4 flex flex-col rounded-lg p-4 font-medium md:mt-0 md:flex-row md:items-center md:space-x-8 md:bg-transparent md:p-0 rtl:space-x-reverse">
          <li>
