      ...
      <div className="relative">
        ...
        {isPassword && !hideEyeIcon && (
          <button
            ...
            className="group absolute inset-y-0 right-0 flex items-center pr-3 focus:outline-none"
            aria-label={showPassword ? 'Hide password' : 'Show password'}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
              className="fill-text-muted h-5 w-5 cursor-pointer transition-all group-hover:brightness-(--highlight-brightness) sm:h-7 sm:w-7"
            >
              {showPassword ? (
