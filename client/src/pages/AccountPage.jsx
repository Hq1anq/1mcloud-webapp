          ...
          <div className="relative z-10 flex flex-col gap-4">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <button
                ...
                className="text-blue bg-text-secondary flex items-center gap-2 rounded-lg px-5 py-2.5 text-sm font-bold shadow-sm transition-colors hover:brightness-90"
              >
                <svg
              ...
              <button className="text-text-secondary flex items-center gap-2 rounded-lg border border-white/20 bg-blue-700/50 px-5 py-2.5 text-sm font-semibold backdrop-blur-sm transition-colors hover:brightness-90">
                <svg
                  className="size-5 fill-none"
                  viewBox="0 0 24 24"
                  strokeWidth={2}
