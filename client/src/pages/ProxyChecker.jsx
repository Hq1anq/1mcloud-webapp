...
export default function ProxyChecker() {
  ...
  return (
    <div>
      <div className="bg-surface border-b border-border z-40 select-none">
        <div className="max-w-7xl mx-auto px-2 py-4 sm:px-4">
          ...
          <div className="bg-wrapper rounded-lg p-4 pb-2">
            <div className="flex flex-col gap-3 md:flex-row md:gap-4">
              ...
              <div className="w-full lg:w-1/2">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <label className="flex items-center text-text-secondary font-medium">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                        className="fill-current h-7 w-7 shrink-0 mr-2">
                    ...
                    <button id="deleteBtn"
                      className="bg-bg-pause hover:brightness-(--highlight-brightness) font-medium py-1 px-2 rounded-lg flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                        className="fill-current mr-1 h-6 w-6 shrink-0">
              ...
              <div className="flex flex-col justify-center gap-2 w-full lg:w-1/2 mt:0 sm:mt-8">
                ...
                <div className="grid grid-cols-[2fr_1fr] grid-rows-2">
                  ...
                  <button id="checkProxiesBtn"
                    className="w-full bg-bg-getData hover:brightness-(--highlight-brightness) font-bold py-2 px-4 rounded-l-lg flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                      className="fill-current mr-1 h-7 w-7 shrink-0 sm:mr-2">
                      <path d="M187.2 100.9C174.8 94.1 159.8 94.4 147.6 101.6C135.4 108.8 128 121.9 128 136L128 504C128 518.1 135.5 531.2 147.6 538.4C159.7 545.6 174.8 545.9 187.2 539.1L523.2 355.1C536 348.1 544 334.6 544 320C544 305.4 536 291.9 523.2 284.9L187.2 100.9z" />
                    </svg>
                    Check Now
                  </button>
                  <DropDown options={['AUTO DETECT', 'HTTPS', 'SOCKS5']}
                    value={proxyType}
                ...
                <div className="grid grid-cols-2 gap-y-2">
                  ...
                  <button id="copyFullProxyBtn"
                    className="flex-1 bg-bg-changeNote hover:brightness-(--highlight-brightness) font-medium py-3 px-4 rounded-r-xl flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                      className="fill-current mr-1 h-7 w-7 shrink-0 sm:mr-2">
                      <path d="M288 64C252.7 64 224 92.7 224 128L224 384C224 419.3 252.7 448 288 448L480 448C515.3 448 544 419.3 544 384L544 183.4C544 166 536.9 149.3 524.3 137.2L466.6 81.8C454.7 70.4 438.8 64 422.3 64L288 64zM160 192C124.7 192 96 220.7 96 256L96 512C96 547.3 124.7 576 160 576L352 576C387.3 576 416 547.3 416 512L416 496L352 496L352 512L160 512L160 256L176 256L176 192L160 192z" />
                    </svg>
                  ...
                  <button id="selectActiveBtn"
                    className="bg-bg-changeIp hover:brightness-(--highlight-brightness) font-medium py-3 px-4 rounded-l-xl flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                      className="fill-current mr-1 h-7 w-7 shrink-0 sm:mr-2">
                  ...
                  <button id="selectErrorBtn"
                    className="bg-bg-pause hover:brightness-(--highlight-brightness) font-medium py-3 px-4 rounded-r-xl flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                      className="fill-current mr-1 h-7 w-7 shrink-0 sm:mr-2">
