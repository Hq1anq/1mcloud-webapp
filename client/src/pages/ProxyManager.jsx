      ...
      <div className="bg-surface border-border z-40 border-b select-none">
        <div className="mx-auto max-w-7xl px-4 py-4">
          ...
          <div className="bg-wrapper rounded-lg p-4">
            <h3 className="text-text-secondary m-1 flex items-center text-lg font-bold sm:text-2xl">
              <svg
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
                ...
                <div className="flex items-center justify-between">
                  <label className="text-text-secondary flex items-center text-sm font-medium sm:text-base">
                    ...
                    <label className="flex flex-wrap">
                      <span className="whitespace-pre">Enter IPs </span>
              ...
              <div className="w-full flex-col">
                ...
                <div className="mt-1 flex flex-wrap">
                  ...
                  <button
                    id="getInfoBtn"
                    className="bg-bg-changeNote m-1 flex flex-1 items-center justify-center rounded-lg px-3 py-2 font-medium hover:brightness-(--highlight-brightness)"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                ...
                <div className="m-1 mt-2 flex">
                  ...
                  <button
                    id="getAPIKeyBtn"
                    className="bg-bg-getAPIKey flex items-center justify-center rounded-r-lg px-3 py-2 font-medium transition-colors duration-200 hover:brightness-(--highlight-brightness)"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 640 640"
        ...
        emptyMessage={
          <div id="emptyState" className="py-12 text-center">
            ...
            <p className="text-text-muted text-base select-none sm:text-xl">
              ...
              Click <span className="text-highlight">Get Data</span> to load information
            </p>
          </div>
        }
