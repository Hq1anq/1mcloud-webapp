      ...
      async (row) => {
        ...
        if (isReplaceMode) {
          ...
          if (needsDateParsing) {
            ...
            if (!dateMatch) {
              return { data: { success: false, error: 'invalid oldNote format for date calculation/extraction' } }
            }
            ...
            if (isNaN(calculatedBaseDate.getTime()) || calculatedBaseDate.getMonth() !== calculatedMonth) {
